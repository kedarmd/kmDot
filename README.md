...
Dotfiles for CachyOS + Hyprland. Source of truth is this repo; sync copies
config to `~/.config/kmdot` and symlinks to standard locations.

## Apps

fish · ghostty · hyprland · nvim · rofi · starship · swaync · waybar · tmux ·
xdg-desktop-portal · theme-switcher · battery
...
- Prefix: `C-s`
- Config: `config/tmux/conf.d/` (modular: 00-base, 10-bindings, 20-theme,
  90-plugins)
- Reload: `C-s r`
...
- **hyprpaper errors on theme switch**: start hyprpaper before switching — the
